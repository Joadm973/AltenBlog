    ...
    <div className="container py-12 animate-fade-in">
      ...
      <div className="mx-auto mt-12 max-w-3xl">
        <Accordion type="single" collapsible className="w-full space-y-4">
          <AccordionItem value="item-1" className="border border-blue-100 rounded-lg bg-white px-6 shadow-sm">
            <AccordionTrigger className="py-4 text-left font-medium text-lg hover:no-underline hover:text-blue-700 data-[state=open]:text-blue-700">
            ...
            <AccordionContent className="text-muted-foreground pt-2 pb-4 pl-10">
          ...
          <AccordionItem value="item-2" className="border border-blue-100 rounded-lg bg-white px-6 shadow-sm">
            <AccordionTrigger className="py-4 text-left font-medium text-lg hover:no-underline hover:text-blue-700 data-[state=open]:text-blue-700">
              <div className="flex items-center gap-3">
                <div className="rounded-full bg-blue-50 p-2 flex-shrink-0">
                  <HelpCircle className="h-5 w-5 text-blue-600" />
          ...
          <AccordionItem value="item-3" className="border border-blue-100 rounded-lg bg-white px-6 shadow-sm">
            <AccordionTrigger className="py-4 text-left font-medium text-lg hover:no-underline hover:text-blue-700 data-[state=open]:text-blue-700">
              <div className="flex items-center gap-3">
                <div className="rounded-full bg-blue-50 p-2 flex-shrink-0">
                  <HelpCircle className="h-5 w-5 text-blue-600" />
          ...
          <AccordionItem value="item-4" className="border border-blue-100 rounded-lg bg-white px-6 shadow-sm">
            <AccordionTrigger className="py-4 text-left font-medium text-lg hover:no-underline hover:text-blue-700 data-[state=open]:text-blue-700">
              <div className="flex items-center gap-3">
                <div className="rounded-full bg-blue-50 p-2 flex-shrink-0">
                  <HelpCircle className="h-5 w-5 text-blue-600" />
