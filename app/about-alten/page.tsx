...
export default function AboutAlten() {  return (
    <div className="container mx-auto px-4 py-12 animate-fade-in">
      ...
      <div className="mt-12 grid gap-8 md:grid-cols-2">
        <div className="space-y-6 p-6 bg-white/50 rounded-xl border border-blue-50 shadow-sm">
          <p className="text-lg">
            Créé il y a plus de 37 ans et présent dans plus de 30 pays, le Groupe <span className="font-semibold text-blue-800">ALTEN</span> s'est imposé comme un leader
          ...
          <p>
            En 2024, <span className="font-semibold text-blue-800">ALTEN</span> a réalisé un chiffre d'affaires de <span className="font-semibold">4,14 milliards d'euros</span> avec <span className="font-semibold">57 700 collaborateurs</span> dans le
          ...
          <p>
            <span className="font-semibold text-blue-800">ALTEN</span> a intégré le Développement Durable au cœur de sa stratégie depuis plus de 10 ans, avec un engagement
            structuré autour de trois piliers : l'innovation durable, l'environnement et l'humain.
          </p>
        </div>
        <div className="flex items-center justify-center">
          <div className="relative h-[350px] w-full overflow-hidden rounded-xl shadow-lg transition-transform hover:scale-[1.02] duration-300">
...
function StatsCard({ icon: Icon, title, description }: StatsCardProps) {
  return (
    <Card className="overflow-hidden transition-all duration-300 hover:shadow-lg hover:-translate-y-1 border-t-4 border-t-primary">
      <CardContent className="flex flex-col items-center p-6 text-center">
        <div className="mb-4 h-16 w-16 rounded-full bg-gradient-to-br from-blue-50 to-blue-100 flex items-center justify-center shadow-sm">
          <Icon className="h-8 w-8 text-primary" />
        </div>
        <h4 className="text-2xl font-bold bg-gradient-to-r from-blue-700 to-blue-500 bg-clip-text text-transparent">{title}</h4>
