...
export default function SkillProgress({ name, level, icon: Icon }: SkillProgressProps) {
  return (
    <div className="space-y-2 p-3 border border-blue-100 dark:border-gray-700 bg-white dark:bg-gray-800 rounded-lg transition-all duration-300 hover:shadow-md hover:border-blue-200 dark:hover:border-gray-600">
